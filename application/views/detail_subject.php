...
<body>
     ...
     <img src="<?=base_url()?>upload/subject/<?=$_GET['subject']?>/huge_pic.png" width="100%" alt="">
     ...
     <div class="hot hotcontainer container clearfix ">
        ...
        <div class="hot-content clearfix">
            ...
            <!-- <div class="page">
                <a class="prev" href="<?=($page&&$page>1)?site_url().'/index/all_list?subject='.$subject.'&page='.($page-1):'javascript:void();'?>">&lt;</a>
                <a href="javascript:void();"><?=$page?$page:'1'?></a>
                <a class="next" href="<?=($page&&$page<$total)?site_url().'/index/all_list?subject='.$subject.'&page='.($page+1):'javascript:void();'?>">&gt;</a>
            </div> -->
        </div>
    </div>
...
<script>
    jQuery(function($){
        ...
        (function(){
            ...
            var id = "<?=$_GET['subject']?>";
            new Image().src = base_url+'/index/add_click_num?id='+id;
        })();
